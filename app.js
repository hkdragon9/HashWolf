...
var app = express();
app.use(express.static(__dirname + '/frontend')) //this directs the app to the directory with the html file, __dirname is the directory of the app.js file, in this case my index.html is in a folder called public that is in the same directory, if your index.html is in the same directory as app.js remove the “+ ‘/public/’”
